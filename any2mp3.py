...
def ncm2mp3(ncm_file_path, mp3_file_path):
...
def any2mp3(input_file_path, output_file_path):
    ...
    if suffix == "ncm":
        return ncm2mp3(input_file_path, output_file_path)
    else:
        return True